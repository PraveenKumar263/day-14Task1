...
const input_firstName = input_tag("input", "type", "form-control", "id", "firstName", "First Name");

const label_lastName = label_create("label", "for", "lastName", "Last Name: ");
const input_lastName = input_tag("input", "type", "form-control", "id", "lastName", "Last Name");

const label_address = label_create("label", "for", "address", "Address: ");
const input_address = input_tag("input", "type", "form-control", "id", "address", "Address line");

const label_pincode = label_create("label", "for", "pincode", "Pincode: ");
const input_pincode = input_tag("input", "type", "form-control", "id", "pincode", "");
...
label_foodChoice.innerHTML = "Choice of Food: <i>(must choose atleast 2 out of 5 options)</i>";
...
const button = button_create("button", "type", "submit", "onclick", "foo()", "Submit", "btn btn-secondary btn-md btn-block");
...
const tableCol = div_create("col-md-9");
...
form.id="form";
form.innerHTML = `<h3>Form Submission: </h3>`;
...
const table_header = document.createElement("h1");
table_header.textContent = "Temporary Database";
...
function populateTable(){
    ...
    let input_R = document.querySelectorAll('input');
